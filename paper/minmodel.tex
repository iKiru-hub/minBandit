...
is dependent on the current policy $\tilde{\textbf{W}}^{MV}$. \\ Below \ref{alg:decision}, is reported the pseudo-code for algorithm behind the selection process.
...
\Return $k$
\end{algorithm}\label{alg:decision}
