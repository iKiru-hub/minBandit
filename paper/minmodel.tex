...
The first, \textit{U}, represents the memory traces of the \textit{K} available options (\textit{i.e.}, the bandits), while the second, \textit{V}, encodes their values under the current policy.
