...
Nonetheless, our model show to suffer more than the others from the presence of high entropy. Another perspective is given by the dashed lines representing the average regret, which overall keep getting wider despite a diminishing of the upper bound.
This fact is also confirmed by the bottom plot, which shows the average entropy of the selections for the first and second trial of the simulation.
