...
Nonetheless, one core premise in our model is the lumping of the option representations into single neurons.
This choice is motivated by simplicity, and constitutes an abstraction of the more distributed encoding implemented by actual brain networks \cite{martinRepresentationObjectConcepts2007a}.
